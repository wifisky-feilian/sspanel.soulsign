(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : ((global = typeof globalThis !== "undefined" ? globalThis : global || self),
          factory(((global.auth = global.auth || {}), (global.auth.support = {}))));
	...
	*/
    ...
    // https://tc39.github.io/ecma262/#sec-array.prototype.foreach
    var arrayForEach =
        !STRICT_METHOD$1 || !USES_TO_LENGTH
    ...
    // https://tc39.github.io/ecma262/#sec-object.getownpropertydescriptor
    _export$1(
        { target: "Object", stat: true, forced: FORCED, sham: !descriptors$1 },
        {
        ...
        if (getOwnPropertySymbols$2) {
            ...
            if (enumerableOnly)
                symbols = filter$2(symbols).call(symbols, function (sym) {
                    return getOwnPropertyDescriptor$5(object, sym).enumerable;
                });
    ...
    function _objectSpread2(target) {
        for (var i = 1; i < arguments.length; i++) {
            ...
            if (i % 2) {
                ...
                forEach$3((_context = ownKeys$2(Object(source), true))).call(_context, function (key) {
                ...
                forEach$3((_context2 = ownKeys$2(Object(source)))).call(_context2, function (key) {
                    defineProperty$1(target, key, getOwnPropertyDescriptor$5(source, key));
                });
            }
        }
    ...
    var NullProtoObject$1 = function () {
        ...
        while (length--) delete NullProtoObject$1[PROTOTYPE$2][enumBugKeys[length]];
    ...
    if (isForced_1(NUMBER, !NativeNumber(" 0o1") || !NativeNumber("0b1") || NativeNumber("+0x1"))) {
        ...
        for (
            ...
            if (has(NativeNumber, (key = keys$7[j])) && !has(NumberWrapper, key)) {
                defineProperty$5(NumberWrapper, key, getOwnPropertyDescriptor$6(NativeNumber, key));
            }
        }
    ...
    var wellKnownSymbol$1 = function (name) {
        if (!has(WellKnownSymbolsStore$2, name)) {
            if (nativeSymbol$1 && has(Symbol$2, name)) WellKnownSymbolsStore$2[name] = Symbol$2[name];
    ...
    // https://tc39.github.io/ecma262/#sec-array.prototype.indexof
    _export$1(
        { target: "Array", proto: true, forced: NEGATIVE_ZERO || !STRICT_METHOD$2 || !USES_TO_LENGTH$2 },
        {
    ...
    var collection = function (CONSTRUCTOR_NAME, wrapper, common) {
        ...
        if (
            ...
            IS_WEAK ||
                defineProperty$6(Constructor.prototype, "size", {
                    configurable: true,
                    get: function () {
    ...
    var collectionStrong = {
        getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
            ...
            if (descriptors$1)
                defineProperty$7(C.prototype, "size", {
                    get: function () {
    ...
    var operate = {
        table: function table(_table) {
            var operator =
                arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (item, tools) {};
        ...
        item: function item(index, table) {
            var operator =
                arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (item, index) {};
    ...
    var verify = {
        ...
        property: function property(object, path) {
            var farthest =
                arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (object, bool) {};
            var property = null;
    ...
    function extract(auth, name) {
        ...
        forEach$4(name).call(name, function (name) {
            var _context;

            if (!Object.prototype.hasOwnProperty.call(auth, name))
                throw concat$2(
                    (_context = 'auth.support -> "'.concat(name, '" is not included now, you must choose from: '))
                ).call(_context, keys$6(auth).join("|"));
            save.push(
                _objectSpread2(
                    {
                        name: name,
