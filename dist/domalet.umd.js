(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : ((global = typeof globalThis !== "undefined" ? globalThis : global || self), factory((global.domalet = {})));
	...
	*/
    ...
    var _exist2 = function _exist2(path) {
        ...
        _classPrivateFieldGet(this, _property).name = slice$2(
            (_context = _classPrivateFieldGet(this, _chain).path)
        ).call(_context, -1)[0]; // 获取属性名
                ...
                value: function apply() {
                    ...
                    if (
                        Object.prototype.hasOwnProperty.call(
                            _classPrivateFieldGet(this, _input$1).dependent,
                            "callback"
                        )
                    ) {
                        var _classPrivateFieldGet2, _context;

                        _classPrivateFieldGet(this, _count).dependent = _classPrivateMethodGet(
                            this,
                            _push,
                            _push2
                        ).call(
            ...
            },
            {
                ...
                value: function operate$1() {
                    ...
                    _classPrivateFieldSet(
                        ...
                        _save,
                        operate.table(
                            (_sliceInstancePropert = slice$2(
                                (_context2 = _classPrivateFieldGet(this, _array))
                            )).call.apply(
                                _sliceInstancePropert,
        ...
        return function (source, location, situation) {
            ...
            function message(packet, message) {
                ...
                return concat$2(
                    (_context = concat$2(
                        (_context2 = concat$2(
                            (_context3 = "filter object.".concat(
                                packet.situation[1].path.join("."),
                                " (filter.custom["
                            ))
